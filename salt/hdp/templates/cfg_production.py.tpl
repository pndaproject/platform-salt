...
{% endraw %}
        ...
        },
        {
            "ams-log4j" : {
                "properties_attributes" : { },
                "properties" : {
                    "ams_log_number_of_backup_files" : "10",
                    "ams_log_max_backup_size" : "200",
{% raw %}
...
{% endraw %}
        ...
        },
        {
            ...
            "properties_attributes" : { },
            "properties" : {
                "ams_hbase_log_maxfilesize" : "200",
                "ams_hbase_log_maxbackupindex" : "10",
                "ams_hbase_security_log_maxbackupindex" : "10",
                "ams_hbase_security_log_maxfilesize" : "200",
{% raw %}
...
{% endraw %}
        ...
        },
        {
            "yarn-log4j" : {
                "properties_attributes" : { },
                "properties" : {
                    "yarn_rm_summary_log_max_backup_size" : "200",
                    "yarn_rm_summary_log_number_of_backup_files" : "10",
{% raw %}
...
{% endraw %}
        ...
        },
        {
            "zookeeper-log4j" : {
                "properties_attributes" : { },
                "properties" : {
                    "zookeeper_log_max_backup_size" : "200",
...
{% endraw %}
        ...
        },
        {
            "hive-log4j" : {
                "properties_attributes" : { },
                "properties" : {
                    "hive_log_maxbackupindex" : "10",
                    "hive_log_maxfilesize" : "200",
{% raw %}
...
{% endraw %}
        ...
        },
        {
            "hbase-log4j" : {
               "properties_attributes" : { },
               "properties" : {
                   "hbase_security_log_maxfilesize" : "200",
                   "hbase_security_log_maxbackupindex" : "10",
                   "hbase_log_maxfilesize" : "200",
                   "hbase_log_maxbackupindex" : "10",
{% raw %}
...
{% endraw %}
        ...
        },
        {
            "hdfs-log4j" : {
                "properties_attributes" : { },
                "properties" : {
                    "hadoop_security_log_max_backup_size" : "200",
                    "hadoop_security_log_number_of_backup_files" : "10",
                    "hadoop_log_max_backup_size" : "200",
